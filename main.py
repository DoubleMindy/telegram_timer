...
def notify_progress(secs_left, message_id, sum_time):
	bot.update_message(CHAT_ID, message_id, render_progressbar(sum_time, sum_time-secs_left))
...
def say_hello(text):
	...
	bot.create_countdown(parsed_time, notify_progress, message_id = message_id, sum_time = parsed_time)
